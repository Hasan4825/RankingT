...
trackers.extend(trackerlist('RFSF', 'default', range(0,3), 'RankingAF')) # 1 mdnet
...
#               skip_missing_seq=False, force_evaluation=True, plot_bin_gap=0.05, exclude_invalid_frames=True)
