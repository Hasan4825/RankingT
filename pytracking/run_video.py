...
def main():
    ...
    parser.add_argument('--tracker_name', type=str, default="dimpRank", help='Name of tracking method.')
    parser.add_argument('--tracker_param', type=str, default="dimpRank18", help='Name of parameter file.')
