...
class dimpRankActor(BaseActor):
    ...
    def __call__(self, data):
        ...
        """
        # Run network
        target_scores, iou_scores = self.net(train_imgs=data['train_images'],
        ...
        # loss_iou = self.loss_weight['iou'] * self.objective['iou'](iou_scores, data['proposal_iou'])
        loss_iou = self.loss_weight['iou'] * self.objective['iou'](iou_scores[:,0], iou_scores[:,1])
